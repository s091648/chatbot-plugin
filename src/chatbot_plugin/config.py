...
# Same Grafana Cloud tenant/credentials as the main scrape-analyzer repo's
# backend/src (.env already has these) — OTel traces just land under this
# service's own service.name, no new secrets needed.
